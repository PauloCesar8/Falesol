...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        <img src="../assets/img/NOVA-LOGO-PMS-SEM-ASSINATURA mini.png" class="navbar-brand-img h-100" alt="...">
        <span class="ms-3 font-weight-bold">Falesol</span>
    </a>
  </div>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('user-profile') ? 'active' : '') }} " href="{{ url('user-profile') }}">
            ...
            <span class="nav-link-text ms-1">Perfil de Usuário</span>
        </a>
      </li>
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('user-management') ? 'active' : '') }}" href="{{ url('user-management') }}">
            ...
            <span class="nav-link-text ms-1">Gerenciamento de Usuário</span>
        </a>
      </li>
      {{-- <li class="nav-item mt-2">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('billing') ? 'active' : '') }}" href="{{ url('billing') }}">
          ...
          <span class="nav-link-text ms-1">Consultar Mensagens</span>
        </a>
      </li>
      {{-- <li class="nav-item">
