            ...
            <div class="col-x1-2 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-dark text-gradient">Bem Vindo</h3>
                  <p class="mb-0 ">Crie uma nova conta<br></p>
                  <p class="mb-0">ou faça login:</p>
                </div>
                <div class="card-body">
                  <form role="form" method="POST" action="/session">
                    ...
                    <div class="text-center">
                      ...
                      {{-- <button type="button" class="btn btn-primary w-100 mt-3 mb-0">Teste</button> --}}
                    </div>
                  </form>
                </div>
                ...
                <small class="text-muted">Esqueceu sua senha? Redefina sua senha 
                  ...
                  <p class="mb-4 text-sm mx-auto">
                    Não tem uma conta?
                    <a href="register" class="text-info text-gradient font-weight-bold">Inscrever-se</a>
                  </p>
                </div>
              </div>
            </div>
