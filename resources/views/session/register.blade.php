      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Texto aqui.</p>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                ...
                <div class="text-center">
                  <button type="submit" class="btn bg-gradient-success w-100 my-4 mb-2">Cadastre-se</button>
                </div>
                  <p class="text-sm mt-3 mb-0 text-center">
                    <a href="login" class="text-dark font-weight-bolder">Já tem uma conta?</a>
                  </p>              
              </form>
            </div>
          </div>
